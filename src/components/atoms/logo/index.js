...
const Logo = ({ classes, className, signetOnly, sloganOnly }) => (
  <svg className={className} viewBox="0 0 115.2 100" xmlns="http://www.w3.org/2000/svg">
    <path
      className={classnames({ [classes.hideOnLarge]: signetOnly }, classes.primary)}
    ...
    />
    <path
      className={classnames({ [classes.hideOnLarge]: signetOnly }, classes.secondary)}
    ...
    />
    <path className={classnames(classes.hideOnLarge, classes.primary)} d="M93.7 100h6V42.4h-6" />
    <path
      className={classnames({ [classes.hideOnLarge]: sloganOnly }, classes.primary)}
